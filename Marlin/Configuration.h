...
#define STRING_CONFIG_H_AUTHOR "(thxssio, DEX 3D Printer i3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DEX 3D Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 114.28 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 4, -7.5, -44.55 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 8.5
